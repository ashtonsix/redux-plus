...
/***/ function(module, exports, __webpack_require__) {
	...
	var _xr = __webpack_require__(165);
	...
	var api = exports.api = function api(method, url) {
	  var config = arguments.length <= 2 || arguments[2] === undefined ? {} : arguments[2];
	  var reducer = arguments.length <= 3 || arguments[3] === undefined ? function (s) {
	    return s;
	  } : arguments[3];
	  return function (state, action) {
	    config = typeof config === 'function' ? config(action) : config;
	
	    return (0, _createEffect.createEffect)(reducer(state, action), function () {
	      var _extends2;
	
	      return (0, _xr2.default)(_extends((_extends2 = {}, _defineProperty(_extends2, config.method === 'GET' ? 'params' : 'data', action.payload || {}), _defineProperty(_extends2, 'method', method), _defineProperty(_extends2, 'url', url), _extends2), config)).then(function (response) {
	        return {
	          type: action.type + '_SUCCESS', payload: response.data,
	          meta: { response: response, originalAction: action } };
	      }, function (error) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var log = exports.log = function log() {
	  ...
	  var transformer = arguments.length <= 1 || arguments[1] === undefined ? 'payload' : arguments[1];
	  return function (state, action) {
	    var result = typeof transformer === 'function' ? transformer(action) : transformer ? (0, _get3.default)(action, transformer) : action;
	    return (0, _createEffect.createEffect)(state, function () {
