...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, 'defaultGetter', {
	  enumerable: true,
	  get: function get() {
	    return _defaultGetter.defaultGetter;
	  }
	});
	...
	Object.defineProperty(exports, 'defaultSetter', {
	  enumerable: true,
	  get: function get() {
	    return _defaultSetter.defaultSetter;
	  }
	});
	...
	Object.defineProperty(exports, 'replaceNode', {
	  enumerable: true,
	  get: function get() {
	    return _metadata.replaceNode;
	  }
	});
	
	var _createTransformer = __webpack_require__(147);
	
	Object.defineProperty(exports, 'createTransformer', {
	  enumerable: true,
	  get: function get() {
	    return _createTransformer.createTransformer;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createTransformer = exports.createTransformer = function createTransformer(transformerMap) {
	  return function (state, action) {
	    // If action.type = [AUTH]_LOGIN(FOO, BAR) then
	    // transformers = [transformerMap[AUTH], transformerMap[FOO], transformerMap[BAR]]
	    var transformers = (0, _flatten3.default)((action.type.match(/[\[\(][\w\s,]+[\]\)]/g) || []).map(function (v) {
	      return v.slice(1, -1).split(',');
	    })).map(function (key) {
	      return transformerMap[key.trim()];
	    });
	    ...
	    var actionTypeTransformer = function actionTypeTransformer(_action) {
	      return _extends({}, _action, {
	        type: action.type.replace(/[\[\]]/g, '').replace(/\([\w\s,]+\)/g, '') });
	    };
	
	    transformers = [actionTypeTransformer].concat(transformers);
	
	    // [transformer1, transformer2] becomes transformer2(transformer1(action))
	    return (0, _createEffect.createEffect)(state, transformers.reduce(function (newAction, transformer) {
	      return transformer(newAction);
	    }, action));
	  };
	};
